...
* [**era**](https://cran.r-project.org/package=era) provides a consistent representation of year-based time scales as a numeric vector with an associated era.
